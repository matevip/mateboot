<template>
	<div class="sc-upload" :class="{'sc-upload-round':round}" :style="style">
		...
		<el-dialog title="剪裁" draggable v-model="cropperDialogVisible" :width="580" @closed="cropperClosed" destroy-on-close>
			<m-cropper :src="cropperFile.tempCropperFile" :compress="compress" :aspectRatio="aspectRatio" ref="cropper"></m-cropper>
			<template #footer>
...
<script>
	...
	const MCropper = defineAsyncComponent(() => import('@/components/MCropper'))
