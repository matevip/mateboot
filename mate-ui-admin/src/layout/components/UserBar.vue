<template>
	<div class="user-bar">
		<div class="panel-item hidden-sm-and-down" @click="searchBy">
			<el-icon><el-icon-search /></el-icon>
		</div>
		<div class="screen panel-item hidden-sm-and-down" @click="screen">
			<el-icon><el-icon-full-screen /></el-icon>
		</div>
		<div class="tasks panel-item" @click="tasksBy">
...
onMounted(() => {
	var userInfo = store.userStore.user
	userName.value = userInfo.username;
	userNameF.value = userName.value.substring(0, 1);
})

//个人信息
const handleUser = (command: any) => {
	if (command == "uc") {
