...
<script>
	...
	export default {
		...
		methods: {
			...
			getMods(){
				//这里可用改为读取远程数据
				this.myModsName =Storage.getItem("my-mods") || []
				var menuTree = Storage.getItem("MENU")
...
<style scoped>
	...
	.modItem-add:hover,.modItem-add:hover i {border-color: #0058DC;color: #0058DC!important;}
